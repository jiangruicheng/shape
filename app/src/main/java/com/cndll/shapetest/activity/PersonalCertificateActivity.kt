...
class PersonalCertificateActivity : BaseActivity<ActivityPersonalCertificateBinding>() {
    ...
    var type=1
    lateinit var simUserCard:File
    lateinit var simCardZ:File
    lateinit var simCardF:File
    ...
    private fun initView(){
        binding.simUserCard.setOnClickListener {  //手持
            type=1
            photo.getImageFromAlbum(this@PersonalCertificateActivity)
        }
        binding.simCardZ.setOnClickListener {   //正
            type=2
            photo.getImageFromAlbum(this@PersonalCertificateActivity)
        }
        binding.simCardF.setOnClickListener {    //反
            type=3
            photo.getImageFromAlbum(this@PersonalCertificateActivity)
        }
