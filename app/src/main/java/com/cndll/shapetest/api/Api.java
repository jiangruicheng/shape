...
public interface Api {
    ...
    @Multipart
    @POST("mobile/index.php/")
    Observable<HttpCodeResponse> authentica(@PartMap Map<String, RequestBody> map);
    ...
    @FormUrlEncoded
    @POST("mobile/index.php/")
    Observable<AuthenticationResponse> acthenInfo(@Field("act") String act, @Field("op") String op, @Field("key") String key, @Field("id") String id);
    ...
    @FormUrlEncoded
    @POST("mobile/index.php/")
    Observable<ApplyInfoResponse> applyInviteCode(@Field("act") String act, @Field("op") String op, @Field("key") String key, @Field("invite_member_name") String invite_member_name, @Field("invite_type") String invite_type, @Field("superior_code") String superior_code);
    ...
    @FormUrlEncoded
    @POST("mobile/index.php/")
    Observable<ApplyInfoResponse> applyInvite(@Field("act") String act, @Field("op") String op, @Field("key") String key, @Field("invite_member_name") String invite_member_name, @Field("invite_type") String invite_type);
    ...
    @FormUrlEncoded
    @POST("mobile/index.php/")
    Observable<ApplyInfoResponse> applyInfo(@Field("act") String act, @Field("op") String op, @Field("key") String key);
