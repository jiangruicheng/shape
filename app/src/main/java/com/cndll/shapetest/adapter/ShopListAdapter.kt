 ...
 */
class ShopListAdapter(private val contentValues: List<CollectResponse.DatasBean.FavoritesListBean>?, private val context: Context) : BaseAdapter() {
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        holder.shopSim.setImageURI(contentValues[position].store_avatar_url)
        holder.shopName.text=contentValues[position].store_name
        holder.shopAccount.text=contentValues[position].store_sales
        holder.shopAllAccount.text=contentValues[position].goods_count
